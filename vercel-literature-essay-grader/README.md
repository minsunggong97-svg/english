# Literature Essay Grader - Vercel 배포용

중세 문학 학습지를 기반으로 만든 문학 서술형 답안 AI 채점 앱입니다.
...
- 직접 답안 입력
- Gemini 기반 AI 채점
- 점수, 등급, 잘한 점, 감점 사유, 누락 키워드, 개념 오류, 보완점, 모범답안, 공부 팁 제공
...
```text
vercel-literature-essay-grader/
├── index.html
├── api/
│   └── grade-answer.js
├── .env.example
...
2. Root Directory를 `vercel-literature-essay-grader`로 지정합니다.
